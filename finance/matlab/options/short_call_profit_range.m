function [asset_prices, profits]=short_call_profit_range(strike_price, option_price, asset_price_start, asset_price_end, count)
	...
	for i=1:d2
		if asset_prices(i) <= strike_price
			...
			profits(i) = strike_price + option_price - asset_prices(i);
		end
	end
end